...
namespace Cars.Classes.Contextos
{
    ...
    {
        // Propriedade DbSet para a entidade Estoque
        ...
        {
            string caminho = @"Server=ECFP507D1319387\SQLEXPRESS01;Database=Automoveis;Trusted_Connection=True;TrustServerCertificate=True";
